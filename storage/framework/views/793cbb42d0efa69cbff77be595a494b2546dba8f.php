        ...
        <?php if(count($productCategoriesTree) > 0): ?>
          <?php $__currentLoopData = $productCategoriesTree; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(isset($cat['parent']) && $cat['parent'] == 'Parent Category'): ?>
              <li class="has-children"><span><a href="#"><?php echo $cat['name']; ?></a><span class="sub-menu-toggle"></span></span>
          ...
          <div class="lang-currency-switcher dropdown-toggle">
            ...
            <?php if(count(get_frontend_selected_languages_data()) > 0): ?>
                <?php if(get_frontend_selected_languages_data()['lang_code'] == 'en'): ?>
                  ...
                  <img alt="<?php echo get_frontend_selected_languages_data()['lang_name']; ?>" src="<?php echo e(asset('images/'. get_frontend_selected_languages_data()['lang_sample_img'])); ?>">

                <?php else: ?>

                  <img alt="<?php echo get_frontend_selected_languages_data()['lang_name']; ?>" src="<?php echo e(get_image_url(get_frontend_selected_languages_data()['lang_sample_img'])); ?>">
            ...
            <?php $available_lang = get_available_languages_data_frontend();?>  
                ...
                <?php $__currentLoopData = get_available_languages_data_frontend(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <?php if($val['lang_code'] == 'en'): ?>
                    ...
                    <a class="dropdown-item" href="#" data-lang_name="<?php echo e($val['lang_code']); ?>"><img src="<?php echo e(asset('images/'. $val['lang_sample_img'])); ?>" alt="&nbsp;<?php echo ucwords($val['lang_name']); ?>">&nbsp;<?php echo ucwords($val['lang_name']); ?>s</a>

                  <?php else: ?>

                    <a class="dropdown-item" href="#" data-lang_name="<?php echo e($val['lang_code']); ?>"><img src="<?php echo e(get_image_url($val['lang_sample_img'])); ?>" alt="&nbsp;<?php echo ucwords($val['lang_name']); ?>">&nbsp;<?php echo ucwords($val['lang_name']); ?>s</a>
