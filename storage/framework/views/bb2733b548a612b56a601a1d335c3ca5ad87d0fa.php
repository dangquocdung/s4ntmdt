      ...
      <div class="topbar d-flex justify-content-between">
        ...
        <?php if(get_site_logo_image()): ?>            
          <div class="site-branding d-flex">
            <a class="site-logo align-self-center" href="<?php echo e(route('home-page')); ?>">
              <img src="<?php echo e(get_site_logo_image()); ?>" title="<?php echo e(trans('frontend.your_store_label')); ?>" alt="<?php echo e(trans('frontend.your_store_label')); ?>">
            </a>
          </div>
        <?php endif; ?>
        <!-- Search / Categories-->
              ...
              <?php if(count(get_frontend_selected_languages_data()) > 0): ?>
                <?php if(get_frontend_selected_languages_data()['lang_code'] == 'en'): ?>
                  ...
                  <a href="#">
                    <div>
                      <i class="flag-icon">
                        <img src="<?php echo e(asset('images/'. get_frontend_selected_languages_data()['lang_sample_img'])); ?>" alt="lang">
                      </i>
                      <span class="text-label"><?php echo get_frontend_selected_languages_data()['lang_name']; ?></span>
                    </div>
                  </a>
                <?php else: ?>
                  ...
                  <a href="#">
                    <div>
                      <i class="flag-icon">
                        <img src="<?php echo e(get_image_url(get_frontend_selected_languages_data()['lang_sample_img'])); ?>" alt="lang">
                      </i>
                      <span class="text-label"><?php echo get_frontend_selected_languages_data()['lang_name']; ?></span>
                    </div>
                  </a>
              ...
              <?php $available_lang = get_available_languages_data_frontend();?>  
                ...
                <?php $__currentLoopData = get_available_languages_data_frontend(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($val['lang_code'] == 'en'): ?>
                    <li>
                      <a href="#" data-lang_name="<?php echo e($val['lang_code']); ?>"><i class="flag-icon"><img src="<?php echo e(asset('images/'. $val['lang_sample_img'])); ?>" alt="lang"></i>&nbsp;<?php echo ucwords($val['lang_name']); ?></a>
                    </li>

                  <?php else: ?>
                    <li>
                      <a href="#" data-lang_name="<?php echo e($val['lang_code']); ?>"><i class="flag-icon"><img src="<?php echo e(get_image_url($val['lang_sample_img'])); ?>" alt="lang"></i>&nbsp;<?php echo ucwords($val['lang_name']); ?></a>
                    </li>
                  <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
