...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title"><?php echo e(trans('admin.update_post_page_title')); ?> &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.testimonial_post_list_content')); ?>"><?php echo e(trans('admin.posts_list')); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.testimonial_post_content')); ?>"><?php echo e(trans('admin.add_new_post_top_title')); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" target="_blank" href="<?php echo e(route('testimonial-single-page', $testimonial_update_data['post_slug'])); ?>"><?php echo e(trans('admin.view')); ?></a></h3>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body testimonial-content">
          <div class="uploaded-testimonial-image">
            ...
            <div class="testimonial-sample-img" style="display: none;"><img class="upload-icon img-responsive" src="<?php echo e(default_upload_sample_img_src()); ?>"></div>
            <div class="testimonial-uploaded-image" style="display:block;"><img class="img-responsive" src="<?php echo e(get_image_url($testimonial_update_data['testimonial_image_url'])); ?>"><div class="remove-img-link"><button type="button" data-target="testimonial_image" class="btn btn-default attachtopost"><?php echo e(trans('admin.remove_image')); ?></button></div></div>
            <?php else: ?>
              <div class="testimonial-sample-img" style="display:block;"><img class="upload-icon img-responsive" src="<?php echo e(default_upload_sample_img_src()); ?>"></div>
