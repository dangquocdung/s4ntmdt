...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title"><?php echo trans('admin.update_product'); ?> &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.product_list', 'all')); ?>"><?php echo trans('admin.products_list'); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.add_product')); ?>"><?php echo trans('admin.add_new_product'); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" target="_blank" href="<?php echo e(route( 'details-page', $product_post_data['post_slug'])); ?>"><?php echo trans('admin.view'); ?></a></h3>
      <div class="box-tools pull-right">
        <button class="btn btn-primary pull-right btn-sm" type="submit"><?php echo trans('admin.update'); ?></button>
      </div>
    </div>
  </div>
        ...
        <div class="box-body product-tab-content">
          <div class="tabbable tabs-left">
            <ul class="nav nav-tabs">
              <?php if($product_post_data['post_type'] == 'simple_product'): ?>
              <li class="nav-item general"><a class="nav-link active" href="#tab_general" data-toggle="tab"><?php echo trans('admin.general'); ?></a></li>
              <li class="nav-item inventory"><a class="nav-link" href="#tab_stock" data-toggle="tab"><?php echo trans('admin.inventory'); ?></a></li>
              <li class="nav-item features"><a class="nav-link" href="#tab_features" data-toggle="tab"><?php echo trans('admin.features'); ?></a></li>
              <li class="nav-item advanced"><a class="nav-link" href="#tab_advanced" data-toggle="tab"><?php echo trans('admin.advanced'); ?></a></li>
              <li class="nav-item attribute" style="display:none;"><a class="nav-link" href="#tab_attribute" data-toggle="tab"><?php echo trans('admin.attributes'); ?></a></li>
              <li class="nav-item variations" style="display:none;"><a class="nav-link" href="#tab_variations" data-toggle="tab"><?php echo trans('admin.variations'); ?></a></li>
              <li class="nav-item custom-design" style="display:none;"><a class="nav-link" href="#tab_custom_design" data-toggle="tab"><?php echo trans('admin.edit_design_elements'); ?></a></li>
              <li class="nav-item custom-design-layout" style="display:none;"><a class="nav-link" href="#tab_custom_design_layout" data-toggle="tab"><?php echo trans('admin.create_layout'); ?></a></li>
														<li class="nav-item manage-download-files" style="display:none;"><a class="nav-link" href="#tab_manage_download_files" data-toggle="tab"><?php echo trans('admin.manage_download_files'); ?></a></li>
              <?php endif; ?>
              
              <?php if($product_post_data['post_type'] == 'configurable_product'): ?>
              <li class="nav-item general" style="display:none;"><a class="nav-link" href="#tab_general" data-toggle="tab"><?php echo trans('admin.general'); ?></a></li>
              <li class="nav-item inventory" style="display:none;"><a class="nav-link" href="#tab_stock" data-toggle="tab"><?php echo trans('admin.inventory'); ?></a></li>
              <li class="nav-item features"><a class="nav-link active" href="#tab_features" data-toggle="tab"><?php echo trans('admin.features'); ?></a></li>
              <li class="nav-item advanced"><a class="nav-link" href="#tab_advanced" data-toggle="tab"><?php echo trans('admin.advanced'); ?></a></li>
              <li class="nav-item attribute"><a class="nav-link" href="#tab_attribute" data-toggle="tab"><?php echo trans('admin.attributes'); ?></a></li>
              <li class="nav-item variations"><a class="nav-link" href="#tab_variations" data-toggle="tab"><?php echo trans('admin.variations'); ?></a></li>
              <li class="nav-item custom-design" style="display:none;"><a class="nav-link" href="#tab_custom_design" data-toggle="tab"><?php echo trans('admin.edit_design_elements'); ?></a></li>
              <li class="nav-item custom-design-layout" style="display:none;"><a class="nav-link" href="#tab_custom_design_layout" data-toggle="tab"><?php echo trans('admin.create_layout'); ?></a></li>
              <li class="nav-item manage-download-files" style="display:none;"><a class="nav-link" href="#tab_manage_download_files" data-toggle="tab"><?php echo trans('admin.manage_download_files'); ?></a></li>
              <?php endif; ?>
              ...
              <li class="nav-item attribute"><a class="nav-link" href="#tab_attribute" data-toggle="tab"><?php echo trans('admin.attributes'); ?></a></li>
              <li class="nav-item variations"><a class="nav-link" href="#tab_variations" data-toggle="tab"><?php echo trans('admin.variations'); ?></a></li>
              <li class="nav-item custom-design"><a class="nav-link" href="#tab_custom_design" data-toggle="tab"><?php echo trans('admin.edit_design_elements'); ?></a></li>
              <li class="nav-item custom-design-layout"><a class="nav-link" href="#tab_custom_design_layout" data-toggle="tab"><?php echo trans('admin.create_layout'); ?></a></li>
              <li class="nav-item manage-download-files" style="display:none;"><a class="nav-link" href="#tab_manage_download_files" data-toggle="tab"><?php echo trans('admin.manage_download_files'); ?></a></li>
              <?php endif; ?>
              ...
              <li class="nav-item custom-design" style="display:none;"><a class="nav-link" href="#tab_custom_design" data-toggle="tab"><?php echo trans('admin.edit_design_elements'); ?></a></li>
              <li class="nav-item custom-design-layout" style="display:none;"><a class="nav-link" href="#tab_custom_design_layout" data-toggle="tab"><?php echo trans('admin.create_layout'); ?></a></li>
              <li class="nav-item manage-download-files"><a class="nav-link" href="#tab_manage_download_files" data-toggle="tab"><?php echo trans('admin.manage_download_files'); ?></a></li>
              <?php endif; ?>
            </ul>
            <div class="tab-content">
              <div class="tab-general tab-pane fade <?php echo e($tabSettings['generalTab']); ?>" id="tab_general">
                ...
                <div class="role-based-pricing-content">
                  ...
                  ?>
                  <div class="form-group">
                    <label class="col-12 control-label" for="inputRoleBasedPricingText<?php echo e($roles['role_name']); ?>"><?php echo trans('admin.user_pricing_top_label', ['user_role' => $roles['role_name']]); ?></label>
                  </div>
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
              ...
              <div class="tab-features tab-pane fade <?php echo e($tabSettings['featureTab']); ?>" id="tab_features">
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
              ...
              <div class="tab-advanced tab-pane fade" id="tab_attribute">
                <div class="form-group">
                  <div class="row">  
                    ...
                    <div class="col-sm-3">
                      <a class="btn btn-default btn-sm add-new-attribute" href=""><?php echo trans('admin.add_attribute'); ?></a>
                    </div>
                  </div>    
                </div>
                <hr><br>
                              ...
                              <td>
                                <div class="btn-group">
                                  ...
                                  <ul role="menu" class="dropdown-menu">
                                    <li><a href="#" data-toggle="modal" data-target="#edit_attributes" class="edit-attribute-data" data-track_name="attr_data_list" data-id="<?php echo e($product_post_data['id']); ?>" data-line_variation_json="<?php echo e(json_encode( array('id' =>$row->id, 'attr_name' =>$row->attr_name, 'attr_val' =>$row->attr_val ))); ?>"><i class="fa fa-edit"></i><?php echo trans('admin.edit'); ?></a></li>
                        ...
                        <div class="modal-body">             
                          <div class="form-group">
                            <div class="row">  
                              ...
                              <div class="col-sm-4">
                                <a class="btn btn-default update-attribute btn-sm" href=""><?php echo e(trans('admin.update_attribute')); ?></a>
                              </div>
                            </div>    
                          </div>
                        </div>
              ...
              <div class="tab-variations tab-pane fade" id="tab_variations">
                <div class="modal fade" id="addDynamicVariations" tabindex="-1" role="dialog" aria-labelledby="updater" aria-hidden="true">
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      <div class="modal-header">
                        <p class="no-margin"><?php echo trans('admin.create_new_product_variation'); ?></p>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>  
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            ...
                            <a data-id="<?php echo e($row->id); ?>" class="pull-right" href=""><span class="fa fa-remove remove-panel"></span></a>
                          </h4>
                        </div>
                                ...
                                <div class="col-sm-6">
                                  <div class="design-img-content">
                                    ...
                                    <div class="design-img-upload-btn">
                                      <div><button type="button" data-name="only_design_img" class="btn btn-default attachtopost upload-design-img btn-sm"><?php echo trans('admin.upload_design_image'); ?></button></div>
                                      <div>
                                        <?php if($row->design_img_url): ?>
                                          <button type="button" data-name="design_img" data-id="solid-<?php echo e($row->id); ?>" class="btn btn-default attachtopost remove-design-img btn-sm" style="display:block;"><?php echo trans('admin.remove_image'); ?></button>
                                        <?php else: ?>
                                          <button type="button" data-name="design_img" data-id="solid-<?php echo e($row->id); ?>" class="btn btn-default attachtopost remove-design-img btn-sm" style="display:none;"><?php echo trans('admin.remove_image'); ?></button>
                                        <?php endif; ?>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div class="col-sm-6">
                                  <div class="design-img-content">
                                    ...
                                    <div class="trans-design-img-upload-btn">
                                      <div><button type="button" data-name="only_trans_design_img" class="btn btn-default attachtopost upload-design-img btn-sm"><?php echo trans('admin.upload_design_transparent_image'); ?></button></div>
                                      <div>
                                        <?php if($row->design_trans_img_url): ?>
                                        <button type="button" data-name="trans_design_img" data-id="trans-<?php echo e($row->id); ?>" class="btn btn-default attachtopost remove-design-img btn-sm" style="display:block;"><?php echo trans('admin.remove_image'); ?></button>
                                        <?php else: ?>
                                        <button type="button" data-name="trans_design_img" data-id="trans-<?php echo e($row->id); ?>" class="btn btn-default attachtopost remove-design-img btn-sm" style="display:none;"><?php echo trans('admin.remove_image'); ?></button>
                                        <?php endif; ?>
                                      </div>
                                    </div>
                                  </div>
                      ...
                      <div class="files-manage-option">
                        <table>
                          ...
                          <tfoot>
                            <tr>
                              <th colspan="2">
                                <button type="button" class="btn btn-default add_more_downloadable_file btn-sm" data-target="simple"> <?php echo trans('admin.downloadable_add_more_file_label'); ?> </button>
                              </th>
                            </tr>
                          </tfoot>
                        </table>
...
<!--          </div> nav-tabs-custom -->
      ...
      <div class="box box-solid compare-data">
        ...
        <div class="box-body">
          <div class="clearfix">
            <a class="btn btn-default pull-right btn-sm" href="<?php echo e(route('admin.extra_features_compare_products_content')); ?>"><?php echo trans('admin.add_compare_data_title'); ?></a>
          </div>  
          <br>  
                ...
                <div class="source-custom-video">                    
                  <div class="modal fade" id="productVideoUploader" tabindex="-1" role="dialog" aria-labelledby="updater" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <p class="no-margin"><?php echo trans('admin.product_vedio_label'); ?></p>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>    
