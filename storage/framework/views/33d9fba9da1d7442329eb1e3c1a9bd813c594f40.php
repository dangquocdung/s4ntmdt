    ...
    <div class="row new-extra-margin">  
      <div class="col-12 col-md-12 col-lg-3">
        <?php if(get_site_logo_image()): ?>
          <div class="logo d-none d-lg-inline"><img src="<?php echo e(get_site_logo_image()); ?>" alt="<?php echo e(trans('frontend.your_store_label')); ?>"></div>
        <?php endif; ?>
      </div> 
      ...
      <div class="col-4 col-md-4 col-lg-3"> 
        <a href="<?php echo e(route('product-comparison-page')); ?>" class="btn btn-light btn-compare"><i class="fa fa-exchange"></i> <span class="d-none d-lg-inline"> &nbsp; <?php echo trans('frontend.compare_label'); ?></span> <span class="compare-value"> (<?php echo $total_compare_item;?>)</span></a>
      </div>
    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark header-menu-nav" role="navigation">
          ...
          <div class="collapse navbar-collapse" id="header_navbar_collapse">
            <ul class="all-menu nav navbar-nav">
              <?php if(Request::is('/')): ?>
                <li><a href="<?php echo e(route('home-page')); ?>" class="main selected"><?php echo trans('frontend.home'); ?></a></li>
              <?php else: ?>
                <li><a href="<?php echo e(route('home-page')); ?>" class="main"><?php echo trans('frontend.home'); ?></a></li>
              <?php endif; ?>
              
              <li class="dropdown mega-dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo trans('frontend.shop_by_cat_label'); ?>  <span class="caret"></span></a>
              ...
              <?php if(Request::is('shop')): ?>
                <li><a href="<?php echo e(route('shop-page')); ?>" class="main selected"><?php echo trans('frontend.all_products_label'); ?></a></li>
              <?php else: ?>
                <li><a href="<?php echo e(route('shop-page')); ?>" class="main"><?php echo trans('frontend.all_products_label'); ?></a></li>
              <?php endif; ?>

              <?php if(Request::is('checkout')): ?>
                <li><a href="<?php echo e(route('checkout-page')); ?>" class="main selected"><?php echo trans('frontend.checkout'); ?></a></li>
              <?php else: ?>
                <li><a href="<?php echo e(route('checkout-page')); ?>" class="main"><?php echo trans('frontend.checkout'); ?></a></li>
              <?php endif; ?>

              <?php if(Request::is('cart')): ?>
                <li><a href="<?php echo e(route('cart-page')); ?>" class="main selected"><?php echo trans('frontend.cart'); ?></a></li>
              <?php else: ?>
                <li><a href="<?php echo e(route('cart-page')); ?>" class="main"><?php echo trans('frontend.cart'); ?></a></li>
              <?php endif; ?>

              <?php if(Request::is('blogs')): ?>
                <li><a href="<?php echo e(route('blogs-page-content')); ?>" class="main selected"><?php echo trans('frontend.blog'); ?></a></li>
              <?php else: ?>
                <li><a href="<?php echo e(route('blogs-page-content')); ?>" class="main"><?php echo trans('frontend.blog'); ?></a></li>
              <?php endif; ?>
...
<?php if($appearance_all_data['header_details']['slider_visibility'] == true && Request::is('/')): ?>
  ...
  <div class="header-with-slider">
    <div id="slider_carousel" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?php echo e(asset('images/sunglass.jpg')); ?>" class="d-block w-100" alt="slide" />
        </div>
      </div>
    </div>
  </div>
