      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="form-group">
            <div class="row">  
              <label class="col-sm-3 control-label" for="inputMetaKeywords"><?php echo e(trans('admin.meta_keywords_label')); ?></label>
              <div class="col-sm-9">
                <input type="text" placeholder="<?php echo e(trans('admin.meta_keywords_example_label')); ?>" id="inputMetaKeywords" name="inputMetaKeywords" class="form-control" value="<?php echo e($seo_data->meta_keywords); ?>">
          ...
          <div class="form-group">
            <div class="row">    
              <label class="col-sm-3 control-label" for="inputMetaDescription"><?php echo e(trans('admin.meta_description_label')); ?></label>
              <div class="col-sm-9">
                <textarea id="inputMetaDescription" name="inputMetaDescription" placeholder="<?php echo e(trans('admin.meta_description_label')); ?>" class="form-control"><?php echo $seo_data->meta_decription; ?></textarea>
              </div>
            </div>  
          </div>
        </div>
