...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title"><?php echo e(trans('admin.update_manufacturers')); ?> &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.manufacturers_list_content')); ?>"><?php echo e(trans('admin.manufacturers_list')); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.add_manufacturers_content')); ?>"><?php echo e(trans('admin.add_more_manufacturers')); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" target="_blank" href="<?php echo e(route('brands-single-page', $manufacturers_update_data['slug'])); ?>"><?php echo e(trans('admin.view')); ?></a></h3>
