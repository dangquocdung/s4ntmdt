        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <div class="row">    
              ...
              <div class="col-sm-8">
                <?php if(is_array($subscription_settings_data['popup_display_page']) && count($subscription_settings_data['popup_display_page']) >0 && in_array('home', $subscription_settings_data['popup_display_page'])): ?>  
                ...
                <?php if(is_array($subscription_settings_data['popup_display_page']) && count($subscription_settings_data['popup_display_page']) >0 && in_array('shop', $subscription_settings_data['popup_display_page'])): ?>  
                  <div style="margin-bottom: 10px;">
                ...
                <?php if(is_array($subscription_settings_data['popup_display_page']) && count($subscription_settings_data['popup_display_page']) >0 && in_array('blog', $subscription_settings_data['popup_display_page'])): ?>  
                  <div style="margin-bottom: 10px;">
                ...
                <?php if(is_array($subscription_settings_data['popup_display_page']) && count($subscription_settings_data['popup_display_page']) >0 && in_array('cart', $subscription_settings_data['popup_display_page'])): ?>  
                  <div style="margin-bottom: 10px;">
