...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title"><?php echo trans('admin.add_new_page_top_title'); ?> &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.all_pages')); ?>"><?php echo trans('admin.all_pages_list'); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.add_page')); ?>"><?php echo e(trans('admin.add_new_page_top_title')); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" target="_blank" href="<?php echo e(route('custom-page-content', $page_data_by_slug['post_slug'])); ?>"><?php echo e(trans('admin.view')); ?></a></h3>
      <div class="box-tools pull-right">
        <button class="btn btn-primary btn-sm" type="submit"><?php echo trans('admin.save'); ?></button>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-8">
      <div class="box box-solid">
        ...
        <div class="box-body">
          <input type="text" placeholder="<?php echo e(trans('admin.example_pages_placeholder')); ?>" class="form-control" name="page_title" id="page_title" value="<?php echo e($page_data_by_slug['post_title']); ?>">
        </div>
      </div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <textarea id="page_description_editor" name="page_description_editor" class="dynamic-editor" placeholder="<?php echo e(trans('admin.post_description_placeholder')); ?>"><?php echo $page_data_by_slug['post_content']; ?></textarea>
        </div>
      </div>
    </div>
    <div class="col-md-4">
