        ...
        <div class="panel-heading">
          <div class="row justify-content-center">
            <div class="col-xs-12 text-center">
              <h3><?php echo e(trans('frontend.forgot_password')); ?></h3>
                ...
                <div class="form-group">
                  <div class="row justify-content-center">
                    <div class="col-sm-6 text-center">
                      <input name="user_forgot_pass_submit" id="user_forgot_pass_submit" class="form-control btn btn-secondary" value="<?php echo e(trans('frontend.reset_my_password')); ?>" type="submit">
                    </div>
                  </div>
                </div>
