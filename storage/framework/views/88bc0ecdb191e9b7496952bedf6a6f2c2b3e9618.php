...
<link rel="stylesheet" href="<?php echo e(URL::asset('/editor/summernote.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(URL::asset('/input-tag/tagmanager.min.css')); ?>" />
...
<script type="text/javascript" src="<?php echo e(URL::asset('/plugins/datepicker/bootstrap-datepicker.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(URL::asset('/plugins/morris/raphael-min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/plugins/morris/morris.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/common/base64.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/js/admin/shopist.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(URL::asset('/dist/js/app.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/editor/summernote.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/input-tag/tagmanager.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/input-tag/bootstrap3-typeahead.min.js')); ?>"></script>
<script src='https://www.google.com/recaptcha/api.js'></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/designer/designer-export.js')); ?>"></script>