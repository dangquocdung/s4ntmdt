          ...
          <div class="left-column-content">
            ...
            <div class="advertisement">
              ...
              <div class="advertisement-content text-center">
                <img class="img-responsive" src="<?php echo e(asset('images/add-sample/shipping.jpg')); ?>" alt="">
              </div>
            </div>
              ...
              <div class="advertisement-right">
                <div id="advertisement-right-carousel" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <div class="text-center">
                        <img src="<?php echo e(asset('images/add-sample/girl.jpg')); ?>" alt="" class="d-block w-100" />
                      </div>
                    </div>
                    <div class="carousel-item">
                      <div class="text-center">
                        <img src="<?php echo e(asset('images/add-sample/sunglass.png')); ?>" alt="" class="d-block w-100" />
                      </div>
                    </div> 
                    <div class="carousel-item">
                      <div class="text-center">
                        <img src="<?php echo e(asset('images/add-sample/mobile.png')); ?>" alt="" class="d-block w-100" />
                      </div>
                    </div>
                  </div>
                  <div class="slider-control-main text-center">
