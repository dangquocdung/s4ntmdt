                ...
                <div class="col mt-15 mb-15">
                    ...
                    <div class="header-logo">
                        <a href="index.html">
                            ...
                            <img class="theme-dark" src="<?php echo e(get_site_logo_image()); ?>" title="<?php echo e(trans('frontend.your_store_label')); ?>" alt="<?php echo e(trans('frontend.your_store_label')); ?>">
                        </a>
                    </div><!-- Logo End -->
                </div>
                <?php endif; ?>
