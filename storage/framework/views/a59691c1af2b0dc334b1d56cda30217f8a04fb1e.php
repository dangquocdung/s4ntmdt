...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-info">
    <div class="box-header">
      <h3 class="box-title"><?php echo e(trans('admin.add_new_manufacturers')); ?> &nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.manufacturers_list_content')); ?>"><?php echo e(trans('admin.manufacturers_list')); ?></a></h3>
