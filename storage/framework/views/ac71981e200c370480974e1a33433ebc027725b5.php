...
<div class="row">
  <div class="col-6">
    <h5><?php echo trans('admin.categories_list'); ?></h5>
  </div>
  <div class="col-6">
    <div class="pull-right">
      <button data-toggle="modal" data-target="#addDynamicCategories" class="btn btn-primary custom-event btn-sm" type="button"><?php echo trans('admin.add_new_category'); ?></button>
    </div>  
  </div>
</div>
<br>
  ...
  <div class="modal-dialog add-cat-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <?php if(Request::is('admin/product/categories/list')): ?>  
        <p class="no-margin"><?php echo trans('admin.create_new_product_category'); ?></p>
        <?php elseif(Request::is('admin/blog/categories/list')): ?>
        <p class="no-margin"><?php echo trans('admin.create_new_blog_category'); ?></p>
        <?php endif; ?>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default attachtopost create-cat btn-sm"><?php echo trans('admin.create_category'); ?></button>
        <button type="button" class="btn btn-default attachtopost btn-sm" data-dismiss="modal"><?php echo trans('admin.close'); ?></button>
      </div>
    </div>
  </div>
</div>
