<?php $__env->startSection('title', trans('admin.update_currency') .' < '. get_site_title()); ?>
...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box">
    <div class="box-header">
      <h3 class="box-title"><?php echo e(trans('admin.update_currency')); ?> &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.custom_currency_settings_list_content')); ?>"><?php echo e(trans('admin.currency_list')); ?></a> &nbsp;&nbsp; <a href="<?php echo e(route('admin.custom_currency_settings_add_content')); ?>" class="btn btn-default btn-sm"><?php echo e(trans('admin.add_new_currency')); ?></a></h3>
        ...
        <div class="box-body">
          <div class="form-group">
            <div class="row">  
              ...
              <div class="col-sm-9">
                  <input type="text" placeholder="<?php echo e(trans('admin.currency_name_label')); ?>" class="form-control" name="currency_name" id="currency_name" value="<?php echo e($currency_update_data->currency_name); ?>">
              </div>
            </div>  
          </div>
                ...
                <select class="form-control select2" name="select_currency" style="width: 100%;"> 
                  <?php if(count(get_available_currency_name())>0): ?>
                    <?php $__currentLoopData = get_available_currency_name(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency_code => $currency_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($currency_update_data->currency_code == $currency_code): ?>
                      <option selected="selected" value="<?php echo e($currency_code); ?>"><?php echo $currency_name; ?></option>
                      <?php else: ?>
          ...
          <div class="form-group">
            <div class="row">  
              ...
              <div class="col-sm-9">
                <input type="number" placeholder="<?php echo e(trans('admin.currency_value_label')); ?>" class="form-control" name="currency_value" id="currency_value" value="<?php echo e($currency_update_data->currency_value); ?>" step="any">
