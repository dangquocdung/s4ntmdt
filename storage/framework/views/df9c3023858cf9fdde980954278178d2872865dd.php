        ...
        <div class="col-md-12">
          <div class="form-group">
            <div class="row">  
              ...
              <div class="col-sm-7">
                <?php if($payment_method_data->cod->status == 'yes'): ?>
          ...
          <div class="form-group">
            <div class="row">  
              ...
              <div class="col-sm-7">
                <input type="text" placeholder="<?php echo e(trans('admin.title')); ?>" class="form-control" name="inputCODTitle" id="inputCODTitle" value="<?php echo e($payment_method_data->cod->title); ?>">
              </div>
            </div>    
          </div>
          ...
          <div class="form-group">
            <div class="row">  
              ...
              <div class="col-sm-7">
                <textarea id="inputCODDescription" name="inputCODDescription" placeholder="<?php echo e(trans('admin.description')); ?>" class="form-control"><?php echo e($payment_method_data->cod->description); ?></textarea>
              </div>
            </div>    
          </div>
          ...
          <div class="form-group">
            <div class="row">  
              ...
              <div class="col-sm-7">
                  <textarea id="inputCODInstructions" name="inputCODInstructions" placeholder="<?php echo e(trans('admin.instructions')); ?>" class="form-control"><?php echo e($payment_method_data->cod->instructions); ?></textarea>
              </div>
            </div>    
          </div>
        </div>
