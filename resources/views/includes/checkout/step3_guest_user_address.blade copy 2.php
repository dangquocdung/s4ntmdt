        ...
        <div class="user-address-content">
            ...
            <div class="address-content-sub">
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" id="account_bill_address_line_1" name="account_bill_address_line_1" placeholder="{{ trans('frontend.address_line_1') }}">asdasd ádasdsadas</textarea>
                    </div>
                </div>
            ...
            <div class="address-content-sub">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                    <label class="control-label" for="inputAccountAddressLine1">{{ trans('frontend.account_address_line_1') }}</label>
                    <textarea class="form-control" id="account_shipping_address_line_1" name="account_shipping_address_line_1" placeholder="{{ trans('frontend.address_line_1') }}">adsdsadsa</textarea>
                    </div>
                </div>
                </div>
