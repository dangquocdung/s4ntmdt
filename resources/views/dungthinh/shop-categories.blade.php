        ...
        <div class="col-lg-3">
          ...
          <aside class="sidebar sidebar-offcanvas position-left"><span class="sidebar-close"><i class="icon-x"></i></span>
            <section class="widget widget-categories">
              ...
              <ul>
                <li><a href="#">Apple</a><span>(254)</span></li>
                <li><a href="#">Bosh</a><span>(39)</span></li>
                <li><a href="#">Canon Inc.</a><span>(205)</span></li>
                <li><a href="#">Dell</a><span>(128)</span></li>
                <li><a href="#">IBM</a><span>(104)</span></li>
                <li><a href="#">Hewlett-Packard</a><span>(35)</span></li>
                <li><a href="#">Hitachi</a><span>(217)</span></li>
                <li><a href="#">Lenovo</a><span>(95)</span></li>
                <li><a href="#">LG Electronics</a><span>(310)</span></li>
                <li><a href="#">Nikon</a><span>(28)</span></li>
                <li><a href="#">Nokia</a><span>(134)</span></li>
                <li><a href="#">Panasonic</a><span>(73)</span></li>
                <li><a href="#">Samsung Electronics</a><span>(1446)</span></li>
                <li><a href="#">Siemens</a><span>(87)</span></li>
                <li><a href="#">Sharp Corporation</a><span>(41)</span></li>
                <li><a href="#">Sony</a><span>(386)</span></li>
                <li><a href="#">Toshiba</a><span>(62)</span></li>
              </ul>
            </section>
          </aside>
        </div>
            ...
            <div class="col-sm-6">
              <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="text-xs text-muted">Starting from &nbsp;<span class='card-label'>$149.80</span></p><a class="btn btn-outline-primary btn-sm" href="shop-grid-ls.html">View Products</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                ...
                <div class="card-body text-center">
                  <h4 class="h6 card-title">TV, Video &amp; Audio</h4>
                  <p class="text-xs text-muted">Starting from &nbsp;<span class='card-label'>$127.00</span></p><a class="btn btn-outline-primary btn-sm" href="shop-grid-ls.html">View Products</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="text-xs text-muted">Starting from &nbsp;<span class='card-label'>$78.00</span></p><a class="btn btn-outline-primary btn-sm" href="shop-grid-ls.html">View Products</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                ...
                <div class="card-body text-center">
                  <h4 class="h6 card-title">Cameras, Photo &amp; Video</h4>
                  <p class="text-xs text-muted">Starting from &nbsp;<span class='card-label'>$310.00</span></p><a class="btn btn-outline-primary btn-sm" href="shop-grid-ls.html">View Products</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                ...
                <div class="card-body text-center">
                  <h4 class="h6 card-title">Headphones</h4>
                  <p class="text-xs text-muted">Starting from &nbsp;<span class='card-label'>$35.99</span></p><a class="btn btn-outline-primary btn-sm" href="shop-grid-ls.html">View Products</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                ...
                <div class="card-body text-center">
                  <h4 class="h6 card-title">Wearable Electronics</h4>
                  <p class="text-xs text-muted">Starting from &nbsp;<span class='card-label'>$79.99</span></p><a class="btn btn-outline-primary btn-sm" href="shop-grid-ls.html">View Products</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                  <div class="inner">
                    <div class="main-img"><img src="img/shop/categories/19.jpg" alt="Category"></div>
                    <div class="thumblist"><img src="img/shop/categories/20.jpg" alt="Category"><img src="img/shop/categories/21.jpg" alt="Category"></div>
                  </div></a>
                <div class="card-body text-center">
                  <h4 class="h6 card-title">Printers &amp; Ink</h4>
                  <p class="text-xs text-muted">Starting from &nbsp;<span class='card-label'>$54.00</span></p><a class="btn btn-outline-primary btn-sm" href="shop-grid-ls.html">View Products</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                  <div class="inner">
                    <div class="main-img"><img src="img/shop/categories/22.jpg" alt="Category"></div>
                    <div class="thumblist"><img src="img/shop/categories/23.jpg" alt="Category"><img src="img/shop/categories/24.jpg" alt="Category"></div>
                  </div></a>
                <div class="card-body text-center">
                  <h4 class="h6 card-title">Video Games</h4>
                  <p class="text-xs text-muted">Starting from &nbsp;<span class='card-label'>$18.50</span></p><a class="btn btn-outline-primary btn-sm" href="shop-grid-ls.html">View Products</a>
                </div>
              </div>
            </div>
          </div>
