            ...
            <ul class="menu" data-initial-height="385">
              ...
              <li class="has-children active"><span><a href="shop-grid-ls.html">Shop</a><span class="sub-menu-toggle"></span></span>
                <ul class="slideable-submenu">
                  ...
                  <li class="active has-children"><span><a href="shop-grid-ls.html">Shop Grid</a><span class="sub-menu-toggle"></span></span>
                    <ul class="slideable-submenu">
                        <li><a href="shop-grid-ls.html">Grid Left Sidebar</a></li>
                        <li><a href="shop-grid-rs.html">Grid Right Sidebar</a></li>
                        <li class="active"><a href="shop-grid-ns.html">Grid No Sidebar</a></li>
                    </ul>
                  </li>
        ...
        <nav class="site-menu">
          <ul>
            ...
            <li class="has-submenu active"><a href="shop-grid-ls.html">Shop</a>
              <ul class="sub-menu">
                  <li><a href="shop-categories.html">Shop Categories</a></li>
                <li class="active has-children"><a href="shop-grid-ls.html">Shop Grid</a>
                  <ul class="sub-menu">
                      <li><a href="shop-grid-ls.html">Grid Left Sidebar</a></li>
                      <li><a href="shop-grid-rs.html">Grid Right Sidebar</a></li>
                      <li class="active"><a href="shop-grid-ns.html">Grid No Sidebar</a></li>
