                ...
                <ul class="slideable-submenu">
                  ...
                  <li class="active has-children"><span><a href="checkout-address.html">Checkout</a><span class="sub-menu-toggle"></span></span>
                    <ul class="slideable-submenu">
                        ...
                        <li class="active"><a href="checkout-shipping.html">Shipping</a></li>
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-8">
          <div class="steps flex-sm-nowrap mb-5"><a class="step" href="checkout-address.html">
              <h4 class="step-title"><i class="icon-check-circle"></i>1. Address</h4></a><a class="step active" href="checkout-shipping.html">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="align-middle"><span class="text-gray-dark">Courier</span><br><span class="text-muted text-sm">All Addresses(default zone), United States & Canada</span></td>
                ...
                <tr>
                  ...
                  <td class="align-middle"><span class="text-gray-dark">UPS Ground Shipping</span><br><span class="text-muted text-sm">All Addresses(default zone)</span></td>
                ...
                <tr>
                  ...
                  <td class="align-middle"><span class="text-gray-dark">Local Pickup from store</span><br><span class="text-muted text-sm">All Addresses(default zone)</span></td>
          ...
          <div class="d-flex justify-content-between paddin-top-1x mt-4"><a class="btn btn-outline-secondary" href="checkout-address.html"><i class="icon-arrow-left"></i><span class="hidden-xs-down">&nbsp;Back</span></a><a class="btn btn-primary" href="checkout-payment.html"><span class="hidden-xs-down">Continue&nbsp;</span><i class="icon-arrow-right"></i></a></div>
        </div>
        <!-- Sidebar          -->
