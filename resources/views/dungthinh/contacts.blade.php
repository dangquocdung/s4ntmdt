  ...
  <body>
    ...
    <div class="container padding-bottom-2x mb-2">
      <div class="row">
        ...
        <div class="col-md-5">
          <ul class="list-icon">
            <li> <i class="icon-mail text-muted"></i><a class="navi-link" href="mailto:customer.service@dungthinh.com">customer.service@dungthinh.com</a></li>
      ...
      <div class="row margin-top-2x">
        ...
        <div class="col-md-5">
          <ul class="list-icon">
            <li> <i class="icon-mail text-muted"></i><a class="navi-link" href="mailto:support@dungthinh.com">support@dungthinh.com</a></li>
          ...
          <div class="card mb-30">
            ...
            <div class="card-body">
              <ul class="list-icon">
                <li> <i class="icon-map-pin text-muted"></i>514 S. Magnolia St. Orlando, FL 32806, USA</li>
                <li> <i class="icon-phone text-muted"></i>+1 (786) 322 560 40</li>
                <li> <i class="icon-mail text-muted"></i><a class="navi-link" href="mailto:orlando.store@dungthinh.com">orlando.store@dungthinh.com</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="card mb-30">
            ...
            <div class="card-body">
              <ul class="list-icon">
                <li> <i class="icon-map-pin text-muted"></i>44 Shirley Ave. West Chicago, IL 60185, USA</li>
                <li> <i class="icon-phone text-muted"></i>+1 (847) 252 765 33</li>
                <li> <i class="icon-mail text-muted"></i><a class="navi-link" href="mailto:chicago.store@dungthinh.comm">chicago.store@dungthinh.com</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="card mb-30">
            ...
            <div class="card-body">
              <ul class="list-icon">
                ...
                <li> <i class="icon-mail text-muted"></i><a class="navi-link" href="mailto:newyork.store@dungthinh.com">newyork.store@dungthinh.com</a></li>
              </ul>
            </div>
          </div>
        </div>
