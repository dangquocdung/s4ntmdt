...
<html lang="en">
  ...
  <body>
            ...
            <ul class="menu" data-initial-height="385">
              <li class="has-children active"><span><a href="index.html">Home</a><span class="sub-menu-toggle"></span></span>
                <ul class="slideable-submenu">
                    ...
                    <li class="active"><a href="home-featured-categories.html">Categories Grid</a></li>
                </ul>
              </li>
          ...
          <ul>
            <li class="has-submenu active"><a href="index.html">Home</a>
              <ul class="sub-menu">
                ...
                <li class="active has-children"><a href="home-featured-categories.html">Categories Grid</a>
                  <ul class="sub-menu w-400 p-0 overflow-hidden">
    ...
    <section class="container-fluid pt-30">
      <div class="row">
        <div class="col-md-6 mb-30"><a class="category-card flex-wrap flex-lg-nowrap" href="shop-grid-ls.html">
            <div class="category-card-info align-self-center">
              <h3 class="category-card-title">Computers &amp; Accessories</h3>
              <h4 class="category-card-subtitle">Starting from $149.80</h4>
              <p class="d-inline-block bg-info text-white mt-3">&nbsp;&nbsp;Shop Now&nbsp;<i class="icon-chevron-right d-inline-block align-middle"></i>&nbsp;</p>
            </div>
            <div class="category-card-thumb"><img src="img/shop/categories/25.jpg" alt="Category"></div></a></div>
        <div class="col-md-6 mb-30"><a class="category-card flex-wrap flex-lg-nowrap" href="shop-grid-ls.html">
            <div class="category-card-info align-self-center">
              <h3 class="category-card-title">Smartphones &amp; Tablets</h3>
              <h4 class="category-card-subtitle">Starting from $78.00</h4>
              <p class="d-inline-block bg-danger text-white mt-3">&nbsp;&nbsp;Shop Now&nbsp;<i class="icon-chevron-right d-inline-block align-middle"></i>&nbsp;</p>
            </div>
            <div class="category-card-thumb"><img src="img/shop/categories/26.jpg" alt="Category"></div></a></div>
        <div class="col-md-6 mb-30"><a class="category-card flex-wrap flex-lg-nowrap" href="shop-grid-ls.html">
            <div class="category-card-info align-self-center">
              <h3 class="category-card-title">TV, Video &amp; Audio</h3>
              <h4 class="category-card-subtitle">Starting from $127.00</h4>
              <p class="d-inline-block bg-warning text-white mt-3">&nbsp;&nbsp;Shop Now&nbsp;<i class="icon-chevron-right d-inline-block align-middle"></i>&nbsp;</p>
            </div>
            <div class="category-card-thumb"><img src="img/shop/categories/28.jpg" alt="Category"></div></a></div>
        <div class="col-md-6 mb-30"><a class="category-card flex-wrap flex-lg-nowrap" href="shop-grid-ls.html">
            <div class="category-card-info align-self-center">
              <h3 class="category-card-title">Video Games</h3>
              <h4 class="category-card-subtitle">Starting from $18.50</h4>
              <p class="d-inline-block bg-success text-white mt-3">&nbsp;&nbsp;Shop Now&nbsp;<i class="icon-chevron-right d-inline-block align-middle"></i>&nbsp;</p>
            </div>
            <div class="category-card-thumb"><img src="img/shop/categories/27.jpg" alt="Category"></div></a></div>
      </div>
    </section>
    <!-- Featured Products-->
    <section class="container padding-top-2x padding-bottom-2x mb-2">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <div class="product-card mb-30"><a class="product-thumb" href="shop-single.html"><img src="img/shop/products/12.jpg" alt="Product"></a>
            <div class="product-card-body">
    ...
    <section class="container padding-top-3x padding-bottom-2x">
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded mx-auto mb-4" src="img/services/02.png" alt="Money Back">
          <h6 class="mb-2">Đảm bảo hoàn tiền</h6>
        ...
        <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded mx-auto mb-4" src="img/services/03.png" alt="Support">
          ...
          <p class="text-sm text-muted mb-0">Friendly Hỗ trợ 24/7</p>
        </div>
