...
<div marginheight="0" marginwidth="0">
  <div style="background-color:#{!! $data['completed_order']['body_bg_color'] !!};margin:0;padding:70px 0 70px 0;width:100%" dir="ltr">
                        ...
                        <tbody>
                          <tr>
                            <td style="padding:36px 48px;display:block">
                              <h1 style="color:#ffffff;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:30px;font-weight:300;line-height:150%;margin:0;text-align:center">{!! $data['completed_order']['email_heading'] !!}</h1>
                            </td>
                          </tr>
                        </tbody>
                      </table>
