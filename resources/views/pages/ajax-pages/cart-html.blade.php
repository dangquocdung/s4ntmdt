        ...
        <div class="shopping-cart-footer">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="">{!! trans('frontend.coupon_label') !!}: <span class="text-medium">{!! price_html( get_product_price_html_by_filter(Cart::couponPrice()), get_frontend_selected_currency() ) !!}</span></div>
              @endif
