...
@section('content')
 <!-- Page Content-->
  <div id="checkout_page" class="container padding-bottom-3x mb-2">
                    ...
                    <tr>
                      <td>
                        <div class="product-item">
                          <a class="product-thumb" href="{{ route('details-page', get_product_slug($items->id)) }}">
                            @if($items->img_src)
                          ...
                          <div class="product-info">
                            <h4 class="product-title">
                              {{-- <a href="shop-single.html">Unionbay Park<small>x 1</small></a> --}}
                      ...
                      <td class="price">{!! price_html( get_product_price_html_by_filter($items->price) ) !!}</td>
                      <td class="quantity">
                        <input type="number" class="form-control cart_quantity_input" name="cart_quantity[{{ $index }}]" value="{{ $items->quantity }}" min="1">
                      </td>
                      <td class="price line-total last-total">
                        {!! price_html(  get_product_price_html_by_filter(Cart::getRowPrice($items->quantity, $items->price) )) !!}
                      </td>
                      <td class="popbtn">
                        <a class="cart_quantity_delete delete-extra-padding" href="{{ route('removed-item-from-cart', $index)}}"><i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                  @endforeach
                  {{-- <tr>
