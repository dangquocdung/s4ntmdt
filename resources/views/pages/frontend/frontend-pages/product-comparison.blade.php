        ...
        <tr>
          ...
          <td>
            <div class="comparison-item">
              ...
              <a class="comparison-item-thumb" href="{{ route('details-page', $products['post_slug']) }}">
        ...
        <tr>
          ...
          @foreach($compare_product_data as $products)
            @if(($label !== 'Image' && $label !== 'Product' && $label !== 'Price') )
              ...
              @if (!empty($products['_product_compare_data']) && isset($products['_product_compare_data'][$key]))
