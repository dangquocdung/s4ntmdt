            ...
            <ul class="menu" data-initial-height="385">
              ...
              <li class="has-children active"><span><a href="shop-grid-ls.html">Shop</a><span class="sub-menu-toggle"></span></span>
                <ul class="slideable-submenu">
                  ...
                  <li class="active has-children"><span><a href="shop-list-ls.html">Shop List</a><span class="sub-menu-toggle"></span></span>
                    <ul class="slideable-submenu">
                        <li><a href="shop-list-ls.html">List Left Sidebar</a></li>
                        <li class="active"><a href="shop-list-rs.html">List Right Sidebar</a></li>
          ...
          <ul>
            ...
            <li class="has-submenu active"><a href="shop-grid-ls.html">Shop</a>
              <ul class="sub-menu">
                ...
                <li class="active has-children"><a href="shop-list-ls.html">Shop List</a>
                  <ul class="sub-menu">
                      <li><a href="shop-list-ls.html">List Left Sidebar</a></li>
                      <li class="active"><a href="shop-list-rs.html">List Right Sidebar</a></li>
                      <li><a href="shop-list-ns.html">List No Sidebar</a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 order-lg-1">
          ...
          <div class="shop-toolbar padding-bottom-1x mb-2">
            ...
            <div class="column">
              <div class="shop-view"><a class="grid-view" href="shop-grid-rs.html"><span></span><span></span><span></span></a><a class="list-view active" href="shop-list-rs.html"><span></span><span></span><span></span></a></div>
            </div>
          </div>
          <!-- Products List-->
          <div class="product-card product-list mb-30"><a class="product-thumb" href="shop-single.html">
              <div class="product-badge bg-danger">Sale</div><img src="img/shop/products/01.jpg" alt="Product"></a>
          ...
          <div class="product-card product-list mb-30"><a class="product-thumb" href="shop-single.html"><img src="img/shop/products/05.jpg" alt="Product"></a>
            <div class="product-card-inner">
              <div class="product-card-body">
          ...
          <div class="product-card product-list mb-30"><a class="product-thumb" href="shop-single.html"><img src="img/shop/products/06.jpg" alt="Product"></a>
            <div class="product-card-inner">
              <div class="product-card-body">
          ...
          <div class="product-card product-list mb-30"><a class="product-thumb" href="shop-single.html"><img src="img/shop/products/07.jpg" alt="Product"></a>
            <div class="product-card-inner">
              <div class="product-card-body">
          ...
          <div class="product-card product-list mb-30"><a class="product-thumb" href="shop-single.html">
              <div class="product-badge bg-secondary border-default text-body">Out of stock</div><img src="img/shop/products/12.jpg" alt="Product"></a>
            <div class="product-card-inner">
              <div class="product-card-body">
          ...
          <div class="product-card product-list mb-30"><a class="product-thumb" href="shop-single.html"><img src="img/shop/products/08.jpg" alt="Product"></a>
            <div class="product-card-inner">
              <div class="product-card-body">
          ...
          <div class="product-card product-list mb-30"><a class="product-thumb" href="shop-single.html">
              <div class="product-badge bg-danger">Sale</div><img src="img/shop/products/09.jpg" alt="Product"></a>
            <div class="product-card-inner">
              <div class="product-card-body">
          ...
          <div class="product-card product-list mb-30"><a class="product-thumb" href="shop-single.html"><img src="img/shop/products/10.jpg" alt="Product"></a>
            <div class="product-card-inner">
              <div class="product-card-body">
                  <div class="rating-stars"><i class="icon-star filled"></i><i class="icon-star filled"></i><i class="icon-star filled"></i><i class="icon-star filled"></i><i class="icon-star"></i>
                  </div>
          ...
          <div class="product-card product-list mb-30"><a class="product-thumb" href="shop-single.html"><img src="img/shop/products/11.jpg" alt="Product"></a>
            <div class="product-card-inner">
              <div class="product-card-body">
