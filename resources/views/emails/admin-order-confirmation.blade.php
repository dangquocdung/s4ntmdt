                                ...
                                <td valign="top" align="center">
                                    <table cellspacing="0" cellpadding="0" border="0" width="650" style="background-color:#fdfdfd;border:1px solid #dcdcdc;border-radius:10px!important">
                                        <tbody>
                                            <tr>
                                                <td valign="top" align="center">
                                                    <table width="650" cellspacing="0" cellpadding="0" border="0" style="background-color:#25003E;border-radius:10px 10px 0 0!important; color:#ffffff;border-bottom:0;font-weight:bold;line-height:100%;vertical-align:middle;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif">
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding:36px 40px;display:block;">
                                                                    <div style="text-align: center;"><img style="height:30px;" src="{{ $_logo }}"></div>
                                                                    <div style="text-align:center;margin-top: 30px;"><h1 style="color:#ffffff;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:30px;font-weight:300;line-height:150%;margin:0;">{!! trans('email.admin_order_email_heading') !!}</h1></div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <td style="font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:14px;text-align:left;padding:20px 30px;"> 
                                                <p style="margin:0 0 16px">{!! trans('email.admin_order_email_msg') !!}</p><br>
                                            ...
                                            <tr>
                                                <td valign="top" align="center" style="padding:0px 30px;">
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" style="font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;border:3px solid #25003E;">
                                                        <thead>
                                                            <tr>
                                                                <th style="text-align:left;color:#FFFFFF;background-color:#25003E;padding:5px 0px 5px 10px;" scope="col">{!! trans('email.product') !!}</th>
                                                                <th style="text-align:center;color:#FFFFFF;background-color:#25003E;padding:5px 0px;" scope="col">{!! trans('email.quantity') !!}</th>
                                                                <th style="text-align:center;color:#FFFFFF;background-color:#25003E;padding:5px 0px;" scope="col">{!! trans('email.price') !!}</th>
                                                                <th style="text-align:center;color:#25003E;background-color:#eeeeee;padding:5px 0px;" scope="col">{!! trans('email.total') !!}</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                        <?php $subTotal = 0;?> 
                                            ...
                                            <tr>
                                                <td valign="top" align="right" style="padding:30px 30px;">
                                                    <table cellspacing="0" cellpadding="0" border="0" style="font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;border:3px solid #25003E;width:60%;">
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:42%;text-align:center;background-color:#eeeeee;padding:10px 0px 10px 0px;background-color: #25003E; color: #FFFFFF;border-bottom:3px solid #e1e1e1;">{!! price_html( get_product_price_html_by_filter($_order_total) ) !!}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top" align="center" style="padding:20px 20px;background-color: #25003E;-webkit-border-bottom-left-radius: 10px;-webkit-border-bottom-right-radius: 10px;-moz-border-radius-bottomleft:10px;-moz-border-radius-bottomright: 10px;border-bottom-right-radius:10px;border-bottom-left-radius:10px;color:#FFF;">
