                                          ...
                                          <tbody>
                                            <tr>
                                              <td width="50%" valign="top">
                                                ...
                                                <p style="color:#505050;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;margin:0 0 16px">{!! $_billing_first_name .' '. $_billing_last_name !!} <br> {!! $_billing_address_1 !!}<br> {!! $_billing_city !!} <br> {!! get_country_by_code($_billing_country) !!}</p>
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
