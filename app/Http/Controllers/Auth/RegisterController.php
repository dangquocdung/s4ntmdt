              ...
              if($User->save()){
                ...
                if($Roleuser->save()){
                  ...
                  $settings_array = array( 
                    'general_settings'  => 
                                          array(
                                              'general_options'     => array('site_title' => 'Dungthinh', 'email_address' => 'yourEmail@domain.com', 'site_logo' => '', 'allow_registration_for_frontend' => true, 'default_role_slug_for_site' => 'site-user'),
