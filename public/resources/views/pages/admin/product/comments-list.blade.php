  ...
  <div class="col-12">
    <div class="box box-solid">
      <div class="box-body">
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu">
                      ...
                      @endif
                      <li><a target="_blank" href="{{ route('details-page', $row->slug) }}"><i class="fa fa-eye"></i>{!! trans('admin.view') !!}</a></li>
        ...
        <br>
        <div class="products-pagination">{!! $product_comments->appends(Request::capture()->except('page'))->render() !!}</div> 
        @endif
      </div>
    </div>
  </div>
