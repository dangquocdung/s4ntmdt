...
__webpack_require__(/*! ./unishop */ "./resources/assets/js/unishop.js"); // window.Vue = require('vue');
...
jQuery(document).ready(function ($) {
  ...
  searchActions('.toolbar .tools .search', '.close-search', '.clear-search', '.site-search'); // Language / Currency Switcher
  //---------------------------------------------------------
  ...
  $('.site-backdrop').on('click', offcanvasClose); // Off-Canvas Menu
  //---------------------------------------------------------
  ...
  }, false); // Animated Scroll to Top Button
  //------------------------------------------------------------------------------
  ...
  filterList($('[data-filter-list]')); // Countdown Function
  //------------------------------------------------------------------------------
  ...
  var rangeSlider = document.querySelector('.ui-range-slider'); // if(typeof rangeSlider !== 'undefined' && rangeSlider !== null) {
